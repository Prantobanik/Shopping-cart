...
document.getElementsByClassName("btn-purchase")[0].addEventListener("click", purchasedBtn);
function purchasedBtn(params) {
...
function addItemToCart(title, price, imgSrc) {
    ...
    cartRow.getElementsByClassName("cart-quantity-input")[0].addEventListener("change",changedQuantity);
    
}

function changedQuantity(e) {
    var input = e.target;
...
function updateCart() {
    ...
    for (let i = 0; i < cartRows.length; i++){
        ...
        var priceItems = cartRow.getElementsByClassName("cart-price")[0];
        var quantityEl = cartRow.getElementsByClassName("cart-quantity-input")[0];
        var price = parseFloat(priceItems.innerText.replace("$", ""));
